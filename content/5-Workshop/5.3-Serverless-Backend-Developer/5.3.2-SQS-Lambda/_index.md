...
![](/AWS-Workshop/images/5-Workshop/5.3-Serverless-Backend-Developer/image-6.png)

Once the queue is successfully created, copy the **Queue URL** and save it for use when configuring the Lambda functions.

![](/AWS-Workshop/images/5-Workshop/5.3-Serverless-Backend-Developer/image-7.png)

Proceed to name the queue and complete the creation process.

![](/AWS-Workshop/images/5-Workshop/5.3-Serverless-Backend-Developer/image-8.png)
...
![](/AWS-Workshop/images/5-Workshop/5.3-Serverless-Backend-Developer/image-9.png)
...
![](/AWS-Workshop/images/5-Workshop/5.3-Serverless-Backend-Developer/image-10.png)
...
![](/AWS-Workshop/images/5-Workshop/5.3-Serverless-Backend-Developer/image-11.png)
...
![](/AWS-Workshop/images/5-Workshop/5.3-Serverless-Backend-Developer/image-12.png)
...
![](/AWS-Workshop/images/5-Workshop/5.3-Serverless-Backend-Developer/image-13.png)
...
- Initiates the processing workflow via AWS Step Functions. ![](/AWS-Workshop/images/5-Workshop/5.3-Serverless-Backend-Developer/image-14.png)

After completing the trigger configuration, review all Lambda functions to ensure the triggers have been correctly linked.

![](/AWS-Workshop/images/5-Workshop/5.3-Serverless-Backend-Developer/image-15.png)
